...
- `self` references (instance variables)
...
if __name__ == "__main__":
    try:
        ...
        if res1 == "Model must be trained first!":
            ...
            print(f"(╥﹏╥) Test 2 (Untrained Predict) Failed. Got: {res1}")
        ...
        if res2 == "Training Complete" and getattr(model, "is_trained", None) == True and getattr(model, "data_size", None) == 3:
             ...
             print("(╥﹏╥) Test 3 (Fit method) Failed.")
        ...
        if res3 == "Predicting based on 3 records":
            ...
            print(f"(╥﹏╥) Test 4 (Trained Predict) Failed. Got: {res3}")
            
        print(f"\nScore: {passed}/4")

    except NameError:
        print("(・_・;) Class 'Model' not defined yet!")
    except Exception as e:
        print(f"(・_・;) Test Error: {e}")
