...
if __name__ == "__main__":
    try:
        ...
        if df.get_column("age") == [20, 25, 30]:
            ...
            print("(╥﹏╥) Test 1 Failed.")
            
        try:
            df.get_column("invalid")
            print("(╥﹏╥) Test 2 (KeyError) Failed. Didn't raise error.")
        except KeyError:
        ...
        if df.mean("salary") == 70000.0:
            ...
            print(f"(╥﹏╥) Test 3 Failed. Got {df.mean('salary')}")
        ...
        if filtered == expected:
            ...
            print(f"(╥﹏╥) Test 4 Failed. Expected {expected}, got {filtered}")
        
        print(f"\nScore: {passed}/4!")

    except NameError:
        print("(・_・;) Class 'DataFrame' not defined!")
